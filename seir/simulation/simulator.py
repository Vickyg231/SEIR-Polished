...
import numpy as np 
def simulate_seir(parameters: Tuple[float,float,float], init_conditions: Tuple[float,float,float,float], days: int = 51) -> Tuple[np.ndarray,np.ndarray, np.ndarray, np.ndarray]:
